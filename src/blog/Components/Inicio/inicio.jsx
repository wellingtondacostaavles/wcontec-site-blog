                ...
                <div id="carouselExampleInterval" className="carousel carousel-dark  slide" data-bs-ride="carousel">            
                    ...
                    <div className="carousel-item" data-bs-interval="3000">
                            <div className="row">
                                ...
                                <div className="col-lg-6">
                                    <h3>Saiu o quarto lote de restituição do<span className="terceiro-h3"> Imposto de Renda 2022</span></h3>                
                                    <h6 className="segundo-h6">Saiba como consultar se o seu nome está na lista do quarto lote de restituição, mas não se preocupe, caso não esteja neste, logo teremos as liberações dos próximos, e nós nos comprometemos a avisá-los assim que forem liberados.</h6>
