                    ...
                    <div className="carousel-item" data-bs-interval="3000">
                            <div className="row">
                                ...
                                <div className="col-lg-6">
                                    ...
                                    <h6 className="segundo-h6">Saiba como consultar se o seu nome está na lista do terceiro lote de restituição, mas não se preocupe, caso não esteja neste, logo teremos as liberações dos próximos, e nós nos comprometemos a avisá-los assim que forem liberados.</h6>
