            ...
            <div className="col-lg-6">
                    <div className="card card-artigos">
                        ...
                        <div className="card-body">
                            ...
                            <a href="/blog-restituicao-ir" className="btn btn-primary btn-artigos zoom-img">Ler Post</a>
                        </div>
                    </div>  
                </div>
            <div className="col-lg-6">
            ...
            <div className="col-lg-6">
                    <div className="card card-artigos">
                        ...
                        <div className="card-body">
                            ...
                            <a href="/blog-deducoes-legais-desconto-simplificado-irpf-22#" className="btn btn-primary btn-artigos zoom-img">Ler Post</a>
                        </div>
                    </div>  
                </div>            
            <div className="col-lg-6">
                    <div className="card card-artigos">
                        ...
                        <div className="card-body">
                            ...
                            <a href="/blog-novidades-na-declaracao-irpf-22" className="btn btn-primary btn-artigos zoom-img">Ler Post</a>
                        </div>
                    </div>  
                </div>
            </div>
            ...
            <div className="col-lg-6">
                    <div className="card card-artigos">
                        ...
                        <div className="card-body">
                            ...
                            <a href="/blog-documentosnecessarios-irpf-22" className="btn btn-primary btn-artigos zoom-img">Ler Post</a>
                        </div>
                    </div>  
                </div>
            <div className="col-lg-6">
                    <div className="card card-artigos">
                        ...
                        <div className="card-body">
                            ...
                            <a href="/blog-normas-para-emissao-e-entrega-do-comprovante-de-rendimentos" className="btn btn-primary btn-artigos zoom-img">Ler Post</a>
                        </div>
                    </div>  
                </div>            
            </div>  
