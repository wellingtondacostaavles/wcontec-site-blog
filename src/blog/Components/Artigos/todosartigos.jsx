...
function Todosartigos(){
    return <section id="todosartigos">      
                ...
                <div className="col-lg-6">
                    <div className="card card-artigos">
                        ...
                        <div className="card-body">
                            ...
                            <a href="/blog/transicaodooperacionalparaoempreendedorismo" className="btn btn-primary btn-artigos">Ler Post</a>
                        </div>
                    </div>  
                </div>  
            </div>  
                ...
                <div className="col-lg-6">
                    <div className="card card-artigos">
                        ...
                        <div className="card-body">
                            ...
                            <a href="/blog/horaextrapassoapassodecomocalcular" className="btn btn-primary btn-artigos">Ler Post</a>
                        </div>
                    </div>  
                </div>  
                ...
                <div className="col-lg-6">
                    <div className="card card-artigos">
                        ...
                        <div className="card-body">
                            ...
                            <a href="/blog/naosepodeculparcargatributaria" className="btn btn-primary btn-artigos">Ler Post</a>
                        </div>
                    </div>  
                </div>  
            </div>  
