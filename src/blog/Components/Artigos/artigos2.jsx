                ...
                <div className="col-lg-6">
                    <div className="card card-artigos">
                        ...
                        <div className="card-body">
                            ...
                            <a href="/blog-brasileiros-preferem-compras-online" className="btn btn-primary btn-artigos zoom-img">Ler Post</a>
                        </div>
                    </div>  
                </div>
                <div className="col-lg-6">
                ...
                <div className="col-lg-6">
                    <div className="card card-artigos">
                        ...
                        <div className="card-body">
                            ...
                            <a href="/blog-profissionais-autonomos-estao-em-crescimento" className="btn btn-primary btn-artigos zoom-img">Ler Post</a>
                        </div>
                    </div>  
                </div>  
            </div>  
                ...
                <div className="col-lg-6">
                    <div className="card card-artigos">
                        ...
                        <div className="card-body">
                            ...
                            <a href="/blog-dicas-para-planejar-o-ano-novo-da-sua-empresa" className="btn btn-primary btn-artigos zoom-img">Ler Post</a>
                        </div>
                    </div>  
                </div>  
                <div className="col-lg-6">
