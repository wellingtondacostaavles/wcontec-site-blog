        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-lg-6">
                    ...
                    <h6>O Sebrae fechou uma parceria com a ACNUR, agência da ONU para refugiados, visando o desenvolvimento de ações de capacitação para refugiados empreendedores, permitindo que ele inscreva seu negócio e divulgue seus produtos e serviços. Também estão disponíveis...</h6>
