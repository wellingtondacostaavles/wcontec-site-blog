        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-lg-6">
                    ...
                    <h6>Sem dúvida a carga tributária é um fator que gera dificuldades a empresários, no entanto muitas empresas, conduzem sua Gestão unicamente baseadas em Faturamento mensal, aí pode estar a razão de mais de 50% das empresas no Brasil encerrarem suas atividades em menos de um ano...</h6>
