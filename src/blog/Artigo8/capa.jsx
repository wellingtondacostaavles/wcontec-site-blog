        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-lg-6">
                    ...
                    <a href="#diferencasmeieirelisluei" className="btn btn-success btn-lg btn-capa-diferencasmeieirelisluei">Continue lendo</a>
                    <a href="/" className="btn btn-outline-primary btn-lg btn-capa-diferencasmeieirelisluei">Área do Cliente</a>
                </div>               
            </div>
        </div>
