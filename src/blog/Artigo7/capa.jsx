        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-lg-6">
                    ...
                    <a href="#empresarioindividual" className="btn btn-success btn-lg btn-capa-empresarioindividual zoom-img">Continue lendo</a>
                    <a href="/" className="btn btn-outline-primary btn-lg btn-capa-empresarioindividual zoom-img">Área do Cliente</a>
                </div>               
            </div>
        </div>
