        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-lg-6">
                    ...
                    <h6>O microempreendedor individual está dispensado de emitir nota fiscal para pessoa física, contudo, quando a venda ou serviço for realizado para uma empresa, será necessário emitir a nota fiscal eletrônica conheça os tipos notas permitidas.</h6>
