...
function Capa(){
    return <section id="capa-a-importrancia-das-retencoes-na-reinf">      
        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-lg-6">
                    ...
                    <a href="#a-importrancia-das-retencoes-na-reinf" className="btn btn-success btn-lg btn-capa-a-importrancia-das-retencoes-na-reinf">Continue lendo</a>
