        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-lg-6">
                    ...
                    <a href="#obrigatoriedade-de-emitir-nota-fiscal" className="btn btn-success btn-lg btn-capa-obrigatoriedade-de-emitir-nota-fiscal zoom-img">Continue lendo</a>
