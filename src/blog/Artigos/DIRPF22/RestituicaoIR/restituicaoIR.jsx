...
function RestituicaoIR(){
    ...
    <section id="restituicao-IR">
                ...
                <div className="container">
                    <div className="row"> 
                        <h3>Restituição do quarto lote do Imposto de Renda 2022</h3>
                    </div>                    
                    ...
                    <p>Clique no botão abaixo e saiba se o seu nome está no quarto lote de restituições do Imposto de Renda 2022</p>
