...
function Obrigatoriedade(){
    ...
    <section id="obrigatoriedade">
                ...
                <div className="container">
                    ...
                    <div className="row">
                    <p><li className="sbAccessibliltyFontSize">Quem recebeu rendimentos maior que R$ 28.559,70 em 2022;</li></p>
                    ...
                    <p><li className="sbAccessibliltyFontSize">Quem teve a posse ou a propriedade, até o último dia do ano de 2022, de bens ou direitos (como imóveis, veículos e investimentos), de valor total superior a R$ 300.000,00;</li></p>
                    ...
                    <p><li className="sbAccessibliltyFontSize">Aqueles que passaram à condição de residente no Brasil e recebeu, até o último dia do ano de 2022, rendimentos com valor acima de R$ 28.559,70;</li></p>
                    ...
                    <div className="col-lg-6">
                        <center><img src="/Images/DIRPF/Obrigatoriedade/capasecundaria.png"/></center>
                    </div>  
                </div>              
            </div>
            ...
            <div className="container">
                <div className="row">
                    <p>Atenção, o prazo do imposto de renda 2023 começou no dia 15 de março e encerra às 23h59min59s, horário de Brasília, do dia 31 de maio de 2023. Após o prazo, a Declaração de Ajuste Anual ainda poderá ser enviada pela Internet ou entregue nas Unidades de Atendimento da Receita Federal, mas o contribuinte terá que arcar com multa pelo atraso.</p>                    
                </div>
            </div>              
    </section>
    <Artigosrelacionados/>
