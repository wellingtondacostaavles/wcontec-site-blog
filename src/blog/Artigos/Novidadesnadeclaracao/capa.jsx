        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-lg-6">
                    ...
                    <h6>Atenção para o prazo de entrega da Declaração do Imposto de Renda Pessoa Física 2022 que começou ontem dia 7, são várias mudanças, e a que chama mais atenção será o recebimento da restituição ou o pagamento do imposto por meio de Pix.</h6>
