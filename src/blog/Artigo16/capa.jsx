        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-lg-6">
                    ...
                    <a href="#normasparaemissaoeentregadocomprovantederendimentos" className="btn btn-success btn-lg btn-capa-normasparaemissaoeentregadocomprovantederendimentos zoom-img">Continue lendo</a>
                    <a href="/" className="btn btn-outline-primary btn-lg btn-capa-normasparaemissaoeentregadocomprovantederendimentos zoom-img">Área do Cliente</a>
                </div>               
            </div>
        </div>
