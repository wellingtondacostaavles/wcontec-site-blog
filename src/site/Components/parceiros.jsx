    ...
    return <section id="parceiros">   
        ...
        <div className="container">
            <div className="row coluna1">
                ...
                <div className="col">
                    <a href="http://bit.ly/3ASk0Nm" target="_blank"><img src="/Images/Parceiros/Serasa.png"/></a>
                </div>
                <div className="col"></div>
            </div>
            <div className="row coluna2">
                ...
                <div className="col">
                    <a href="https://www.instagram.com/arouchagas.supergasbras/" target="_blank"><img src="/Images/Parceiros/ArouchaGas.png"/></a>
                </div>
                <div className="col"></div>
            </div>
        </div>
