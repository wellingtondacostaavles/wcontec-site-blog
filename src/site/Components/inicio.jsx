        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-lg-6">
                    ...
                    <a href="https://wcontec.osayk.com.br/#/cadastro" className="btn btn-success btn-lg btn-banner">Teste Grátis</a>
                    <a href="https://wcontec.osayk.com.br/#/login" className="btn btn-outline-primary btn-lg btn-banner">Acesse a Plataforma</a>
                </div>               
            </div>
        </div>
    </section>;
