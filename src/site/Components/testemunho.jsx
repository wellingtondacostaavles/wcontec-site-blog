        ...
        <div className="container">
            ...
            <div id="carouselExampleControlsNoTouching" className="carousel carousel-dark  slide" data-bs-ride="carousel">            
                <div className="carousel-inner">
                    ...
                    <div className="carousel-item" data-bs-interval="15000">
                        <h2>Minha experiência com a wcontec está sendo excelente, além de poder controlar minhas entradas e saídas de caixa, posso cadastrar uma conta bancária da minha empresa e desta forma a ferramenta já gera o boleto e envia para nossos clientes a cobrança das mensalidades de forma automática.</h2>
