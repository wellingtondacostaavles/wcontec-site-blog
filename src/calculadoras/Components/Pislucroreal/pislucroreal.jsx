...
function Pislucroreal(){   
    ...
    const calcular5 = () =>{  
        if (operacao5=="Somar")
        return (parseFloat(resultado4) * 0.0165);
    }
    ...
    useEffect (() =>{setResultado6(calcular6())},[resultado5, nro32, nro33, nro34, operacao6]);
        ...
        <div className="row text-center">
            ...
            <div className="row text-center">
              ...
              <p><span className="segundo-p">ATENÇÃO: O PIS encontrado na calculadora quando negativo poderá ser utilizado como crédito no mês seguinte e tambem deverá ser confirmado com o contador responsável pela empresa.</span></p>
            </div>
        </div>          
        </section>       
      </div> 
