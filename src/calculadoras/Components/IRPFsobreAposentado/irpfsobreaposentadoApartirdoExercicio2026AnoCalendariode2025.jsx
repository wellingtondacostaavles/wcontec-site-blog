...
function IrpfsobreaposentadoApartirdoExercicio2026AnoCalendariode2025(){  
    ...
    useEffect (() =>{setResultado8(calcular8())},[ValorIRDeducoesLegais, IRRF, operacaoResultdoIRDeducoesLegais]);
        ...
        <section id="Irpf-sobre-aposentado-Apartir-do-Exercicio-2026-Ano-Calendario-de-2025">  
        <NavbarCalculadora/>
        <div className="row text-center">
            ...
            <div className="container">
                <div className="row inputs-Irpf-sobre-aposentado-Apartir-do-Exercicio-2026-Ano-Calendario-de-2025">
  ...
  export default IrpfsobreaposentadoApartirdoExercicio2026AnoCalendariode2025;