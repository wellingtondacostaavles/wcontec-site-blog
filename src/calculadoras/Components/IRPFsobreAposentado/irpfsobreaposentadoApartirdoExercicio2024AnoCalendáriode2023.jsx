...
function IrpfsobreaposentadoApartirdoExercicio2024AnoCalendariode2023(){  
    ...
    useEffect (() =>{setResultado8(calcular8())},[ValorIRDeducoesLegais, IRRF, operacaoResultdoIRDeducoesLegais]);
        ...
        <section id="Irpf-sobre-aposentado-Apartir-do-Exercicio-2024-Ano-Calendário-de-2023">  
        <NavbarCalculadora/>
        <div className="row text-center">
            ...
            <div className="container">
                <div className="row inputs-Irpf-sobre-aposentado-Apartir-do-Exercicio-2024-Ano-Calendário-de-2023">
