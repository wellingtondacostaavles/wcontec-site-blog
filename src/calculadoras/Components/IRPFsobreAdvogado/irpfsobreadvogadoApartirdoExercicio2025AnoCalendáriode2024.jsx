...
function IrpfsobreadvogadoApartirdoExercicio2025AnoCalendariode2024(){  
    ...
    useEffect (() =>{setResultado8(calcular8())},[ValorIRDeducoesLegais, IRRF, operacaoResultdoIRDeducoesLegais]);
        ...
        <section id="irpf-sobre-advogado-Apartir-do-Exercicio-2025-Ano-Calendario-de-2024">  
        <NavbarCalculadora/>
        <div className="row text-center">
            ...
            <div className="container">
                <div className="row inputs-irpf-sobre-advogado-Apartir-do-Exercicio-2025-Ano-Calendario-de-2024">
  ...
  export default IrpfsobreadvogadoApartirdoExercicio2025AnoCalendariode2024;