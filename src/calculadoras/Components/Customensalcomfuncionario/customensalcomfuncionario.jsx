    ...
    useEffect (() =>{setResultado11(calcular11())},[nro1, nro2, nro3, nro4, nro5, resultado1, resultado2, resultado3, resultado4, resultado5, resultado6, resultado7, resultado8, resultado9, resultado10, operacao11]);
        ...
        <div className="row text-center">
                <div className="titulo">
                    ...
                    <p>Funcionário de empresa do Simples Nacional</p>
                </div>
            </div>
                ...
                <div className="col-sm-4">    
                    <div>
                        ...
                        <div className="input-group mb-3">
                            ...
                            <input className="form-control" type="number" aria-label="Amount (to the nearest dollar)"  step="0.01" value={nro1} onChange={(e) => setNro1(e.target.value)}/>
                        </div>                     
                    </div>
                    <div>
