        ...
        <div className="container">
            <div className="row inputs-custo-mensal-com-funcionario">
                <div className="col-sm-3">    
                    <div className="mb-3">
                        ...
                        <div className="input-group mb-3">
                            ...
                            <input className="form-control" type="number" name="nro1-custo-mensal-com-funcionario" id="nro1-custo-mensal-com-funcionario" aria-label="Amount (to the nearest dollar)"  step="0.01" nin="0.00" value={nro1} onChange={(e) => setNro1(e.target.value)}/>
                        </div>                     
                    </div>
                </div>
                ...
                <div className="mb-3">
                        ...
                        <div className="input-group mb-3">
                            <span className="input-group-text">R$</span>
                            <input className="form-control" type="number" name="nro2-custo-mensal-com-funcionario" id="nro2-custo-mensal-com-funcionario" aria-label="Amount (to the nearest dollar)"  step="0.01" value={nro2} onChange={(e) => setNro2(e.target.value)}/>
                        </div>                     
                    </div>
                </div>
                <div className="col-sm-3">
                    <div className="mb-3">
                        ...
                        <div className="input-group mb-3">
                            <span className="input-group-text">R$</span>
                            <input className="form-control" type="number" name="nro3-custo-mensal-com-funcionario" id="nro3-custo-mensal-com-funcionario" aria-label="Amount (to the nearest dollar)"  step="0.01" value={nro3} onChange={(e) => setNro3(e.target.value)}/>
                        </div>                     
                      </div>
                      </div> 
                <div className="col-sm-3"> 
                    <div className="mb-3">
                        ...
                        <div className="input-group mb-3">
                            <span className="input-group-text">R$</span>
                            <input className="form-control" type="number" name="nro4-custo-mensal-com-funcionario" id="nro4-custo-mensal-com-funcionario" aria-label="Amount (to the nearest dollar)"  step="0.01" value={nro4} onChange={(e) => setNro4(e.target.value)}/>
                        </div>                     
                    </div>
                    </div>
                    <div className="col-sm-3">
                    <div className="mb-3">
                        ...
                        <div className="input-group mb-3">
                            <span className="input-group-text">R$</span>
                            <input className="form-control" type="number" name="nro5-custo-mensal-com-funcionario" id="nro5-custo-mensal-com-funcionario" aria-label="Amount (to the nearest dollar)"  step="0.01" value={nro5} onChange={(e) => setNro5(e.target.value)}/>
                        </div>                     
                    </div>
                </div>    
            </div>    
