...
function IrpfsobreempregadocltApartirdoExercicio2026AnoCalendariode2025(){  
    ...
    useEffect (() =>{setResultado8(calcular8())},[ValorIRDeducoesLegais, IRRF, operacaoResultdoIRDeducoesLegais]);
        ...
        <section id="irpf-sobre-empregado-clt-Apartir-do-Exercicio-2026-Ano-Calendario-de-2025">  
        <NavbarCalculadora/>
        <div className="row text-center">
            ...
            <div className="container">
                <div className="row inputs-irpf-sobre-empregado-clt-Apartir-do-Exercicio-2026-Ano-Calendario-de-2025">
  ...
  export default IrpfsobreempregadocltApartirdoExercicio2026AnoCalendariode2025;