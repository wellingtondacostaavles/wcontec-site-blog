...
function IrpfsobreempregadocltApartirdoExercicio2024AnoCalendariode2023(){  
    ...
    useEffect (() =>{setResultado8(calcular8())},[ValorIRDeducoesLegais, IRRF, operacaoResultdoIRDeducoesLegais]);
        ...
        <section id="irpf-sobre-empregado-clt-Apartir-do-Exercicio-2024-Ano-Calendario-de-2023">  
        <NavbarCalculadora/>
        <div className="row text-center">
            ...
            <div className="container">
                <div className="row inputs-irpf-sobre-empregado-clt-Apartir-do-Exercicio-2024-Ano-Calendario-de-2023">
  ...
  export default IrpfsobreempregadocltApartirdoExercicio2024AnoCalendariode2023;