...
function IrpfsobretrabalhadorautonomogeralApartirdoExercicio2025AnoCalendáriode2024(){  
    ...
    useEffect (() =>{setResultado8(calcular8())},[ValorIRDeducoesLegais, IRRF, operacaoResultdoIRDeducoesLegais]);
        ...
        <section id="irpf-sobre-trabalhador-autonomo-geral-Apartir-do-Exercicio-2025-Ano-Calendario-de-2024">  
        <NavbarCalculadora/>
        <div className="row text-center">
            ...
            <div className="container">
                <div className="row inputs-irpf-sobre-trabalhador-autonomo-geral-Apartir-do-Exercicio-2025-Ano-Calendario-de-2024">
  ...
  export default IrpfsobretrabalhadorautonomogeralApartirdoExercicio2025AnoCalendáriode2024;