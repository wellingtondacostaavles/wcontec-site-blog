...
function IrpfsobremeiservicoApartirdoExercicio2026AnoCalendáriode2025(){  
    ...
    useEffect (() =>{setResultado9(calcular9())},[ValorIRDeducoesLegais, IRRF, operacaoResultdoIRDeducoesLegais]);
        ...
        <section id="irpf-sobre-mei-servico-Apartir-do-Exercicio-2026-Ano-Calendario-de-2025">  
        <NavbarCalculadora/>
        <div className="row text-center">
            ...
            <div className="container">
                <div className="row inputs-irpf-sobre-mei-servico-Apartir-do-Exercicio-2026-Ano-Calendario-de-2025">
  ...
  export default IrpfsobremeiservicoApartirdoExercicio2026AnoCalendáriode2025;