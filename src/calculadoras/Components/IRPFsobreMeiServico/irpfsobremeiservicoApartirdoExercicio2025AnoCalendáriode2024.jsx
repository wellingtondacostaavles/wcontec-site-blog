...
function IrpfsobremeiservicoApartirdoExercicio2024AnoCalendáriode2023(){  
    ...
    useEffect (() =>{setResultado9(calcular9())},[ValorIRDeducoesLegais, IRRF, operacaoResultdoIRDeducoesLegais]);
        ...
        <section id="irpf-sobre-mei-servico-Apartir-do-Exercicio-2024-Ano-Calendario-de-2023">  
        <NavbarCalculadora/>
        <div className="row text-center">
            ...
            <div className="container">
                <div className="row inputs-irpf-sobre-mei-servico-Apartir-do-Exercicio-2024-Ano-Calendario-de-2023">
  ...
  export default IrpfsobremeiservicoApartirdoExercicio2024AnoCalendáriode2023;